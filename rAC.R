...
#### Script to investigate correlation between A and C ####
...
c <- .2 # C
e <- .5 # E
rAC <- .3 # correlation between A and C
...
for(i in 1:1000){
  ...
  sigma <- matrix(c(1  ,rAC,0  ,1  ,rAC,0,
                    rAC,1  ,0  ,rAC,1  ,0,
                    0  ,0  ,1  ,0  ,0  ,0,
                    1  ,rAC,0  ,1  ,rAC,0,
                    rAC,1  ,0  ,rAC,1  ,0,
  ...
  ## DZ
  #matrix with correlations between variance components for twin 1 and twin 2
  sigma <- matrix(c(1  ,rAC,0  ,.5 ,rAC,0,
                    rAC,1  ,0  ,rAC,1  ,0,
                    0  ,0  ,1  ,0  ,0  ,0,
                    .5 ,rAC,0  ,1  ,rAC,0,
                    rAC,1  ,0  ,rAC,1  ,0,
